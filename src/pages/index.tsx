                ...
                return (
                  <div className="" key={category.id}>
                    <div className="collapse-title bg-primary text-primary-content">
                      {category.name} - Sản Phẩm: {category.products.length}
                    </div>
                    <div className="flex flex-wrap gap-y-4 bg-base-200 p-4">
                      {category.products.length > 0 &&
                        category.products.map((product) => {
                          return (
                            <div key={product.id} className="w-full p-2 md:w-[50%] lg:w-[25%]">
                              <div className="card-compact card bg-base-100 shadow-xl border border-black">
